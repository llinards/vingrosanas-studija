...
@php
    ...
    $classes = Flux::classes()
        ...
        ->add(match ($variant) { // Text color...
            'primary' => 'uppercase text-black hover:opacity-70',
            'secondary' => 'uppercase text-black hover:text-white',
        ...
        ->add(match ($variant) { // Border color...
            ...
            'secondary' => 'border-2 border-black hover:border-white',
        ...
        ->add(match ($variant) { // Grouped border treatments...
            'ghost' => '',
            'subtle' => '',
            'primary' => 'font-heading-semi-bold tracking-wide transition-all duration-300 cursor-pointer rounded-2xl px-7 py-1 self-start',
            'secondary' => 'font-heading-semi-bold tracking-wide transition-all duration-300 cursor-pointer rounded-2xl px-7 self-start',
...
<flux:with-tooltip :$attributes>
    <flux:button-or-link-pure :$type :attributes="$attributes->class($classes)" data-flux-button>
        ...
        <?php
        if (($loading || $iconLeading || $iconTrailing) && ! $slot->isEmpty()): ?>
