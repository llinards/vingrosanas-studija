...
$classes = Flux::classes()
    ->add('relative flex items-center gap-3')
    ->add($square ? 'px-2.5!' : '')
    ->add('py-0 text-start w-full my-px')
...
<flux:button-or-link :attributes="$attributes->class($classes)" data-flux-navlist-item>
    ...
    <?php if ($slot->isNotEmpty()): ?>
        <div class="flex-1 leading-none whitespace-nowrap [[data-nav-footer]_&]:hidden [[data-nav-sidebar]_[data-nav-footer]_&]:block" data-content>{{ $slot }}</div>
    <?php endif; ?>
