        ...
        <div class="space-y-6">
            ...
            @if($bookingComplete)
                ...
                <div class="text-center space-y-4">
                    ...
                    <flux:modal.close>
                        <flux:button variant="primary">{{ __('Aizvērt') }}</flux:button>
                    </flux:modal.close>
                </div>
            @else
                {{-- STEP INDICATOR --}}
                ...
                @if($step === 1)
                    <div class="space-y-6">
                        ...
                        <div class="flex justify-end">
                            <flux:button wire:click="nextStep" variant="primary">{{ __('Tālāk') }}</flux:button>
                        </div>
                    </div>
                @endif
                ...
                @if($step === 2)
                    <div class="space-y-6">
                        ...
                        <div class="flex justify-between">
                            <flux:button wire:click="previousStep" variant="ghost">{{ __('Atpakaļ') }}</flux:button>
                            <flux:button wire:click="nextStep" variant="primary">{{ __('Tālāk') }}</flux:button>
                        </div>
                    </div>
                @endif
                ...
                @if($step === 4)
                    <div class="space-y-6">
                        ...
                        @if($this->selectedSchedule)
                            <div class="rounded-lg border border-zinc-200 p-4 space-y-2">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <flux:text
                                        class="font-semibold">{{ Number::currency($this->selectedSchedule->service->price / 100, 'EUR') }}</flux:text>
                                </div>
                            </div>

                            <div class="rounded-lg border border-zinc-200 p-4 space-y-1">
                        ...
                        <div class="flex justify-between">
                            <flux:button wire:click="previousStep" variant="ghost">{{ __('Atpakaļ') }}</flux:button>
                            <flux:button wire:click="submitBooking" variant="primary">{{ __('Apmaksāt') }}</flux:button>
                        </div>
                    </div>
                @endif
            @endif
