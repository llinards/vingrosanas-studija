...
<div class="space-y-6">
    ...
    <div class="flex justify-between">
        ...
        <div class="flex flex-col gap-2">
            <flux:button wire:click="submitBooking" class="button small primary">{{ __('Apmaksāt uz vietas') }}
            </flux:button>
            <flux:button wire:click="submitBooking" class="button small primary">{{ __('Apmaksāt ar karti') }}
            </flux:button>
        </div>
    </div>
</div>
