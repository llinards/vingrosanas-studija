<flux:modal.trigger name="{{ $coachModalName }}">
    <div class="group w-full flex flex-col">
        <img
            class="shrink-0 object-cover w-full h-104 sm:h-120 md:h-136 lg:h-196 xl:h-224 lg:grayscale group-hover:grayscale-0 transition-all duration-300 cursor-pointer"
            src="{{ $coachCardImg }}">
