<div class="mx-auto max-w-7xl pb-12 grid lg:grid-cols-2 gap-x-6">
    <div class="container mx-auto flex flex-col justify-center pb-12 lg:pb-0 space-y-6">
        <flux:heading level="2">{{ __('Jaunas telpas, jaunas iespējas') }}</flux:heading>
        <flux:text>{{ __('Mūsu vingrošanas studija tagad ir plašāka un jaudīgāka nekā jebkad - vieta, kur kustība kļūst
            par labsajūtu.') }}</flux:text>
