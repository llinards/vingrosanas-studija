<div class="my-12 grid lg:grid-cols-2 gap-x-6 lg:relative">
    <div class="flex lg:justify-end">
        <div class="lg:h-156 lg:max-w-157 flex flex-col justify-center pb-12 lg:pb-0 px-4">
            ...
            <flux:text class="pb-6">{{ __('Mūsu vingrošanas studija tagad ir plašāka un jaudīgāka nekā jebkad - vieta, kur kustība
