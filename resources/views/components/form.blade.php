<div class="pb-12 mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-x-6 gap-y-12">
    ...
    <div class="flex flex-col text-center lg:text-start space-y-6 lg:space-y-9">
        ...
        <ul class="md:text-xl lg:text-3xl">
            ...
            <li>
                <flux:link variant="ghost" href="mailto:vingrosanas@studija.lv">vingrosanas@studija.lv</flux:link>
            </li>
        </ul>
        <ul class="md:text-xl lg:text-3xl">
            <li class="list-heading">{{ __('Adrese') }}</li>
            <li>
                <flux:link variant="ghost" href="https://maps.app.goo.gl/UdGP64Acxz2RVPJe7" target="_blank">Strēlnieku
                    iela 20
                    A, Sigulda
                </flux:link>
            </li>
